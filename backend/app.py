...
# Define an endpoint to predict sales for a batch of products/stores at once
@superkart_api.post('/v1/batch_predict')
def batch_predict_sales():
    # Get a JSON list of records from the request
    records = request.get_json()

    # Convert the list of records into a DataFrame preserving column order
    ...
    return jsonify({'Sales': predictions})
